...
public class Consts {
    ...
    public static final ClassName ROUTER = ClassName.get(
            "com.grechur.base", "Router");

    public static final String ARGUMENTS_NAME = "moduleName";
    public static final String ANN_TYPE_ROUTE = "com.grechur.route_annotation.ZRoute";
    public static final String ANN_TYPE_Extra = "com.grechur.route_annotation.Extra";


    public static final String IROUTE_GROUP = "com.grechur.base.template.IRouteGroup";
    public static final String IROUTE_ROOT = "com.grechur.base.template.IRouteRoot";
    public static final String IEXTRA = "com.grechur.base.template.IExtra";

    public static final String METHOD_LOAD_INTO = "loadInto";
    public static final String METHOD_LOAD_EXTRA = "loadExtra";

    public static final String ACTIVITY = "android.app.Activity";
    public static final String ISERVICE = "com.grechur.base.template.IService";
    ...
    public static final String PACKAGE_OF_GENERATE_FILE = "com.grechur.base";
